...
* I break my own code just to make it better. Simple as that.

Tools I smash code with:
...
![REST API](https://img.shields.io/badge/REST%20API-6DB33F?style=for-the-badge&logo=rest&logoColor=white)
